package dev.rgbmc.syncable.database;
...
public class VoltDB {
    ...
    protected ConnectionSource getConnectionSource(String host, String user, String password, boolean ssl, int minimum_idle, int maximum_pool_size, int max_lifetime) throws SQLException {
        ...
        String url = "jdbc:voltdb://" + host + "?useSSL=" + ssl
                + "&serverTimezone=UTC&autoReconnect=true&allowPublicKeyRetrieval=true&characterEncoding=utf8&jdbc.committhrowexception=false&jdbc.rollbackthrowexception=false";
